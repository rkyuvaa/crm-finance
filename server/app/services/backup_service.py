...
TABLE_MODELS = [
    ...
    ("hr_payroll_records", PayrollRecord),
    ("hr_performance_reviews", PerformanceReview),
    # Projects & Tasks Module
    ("project_types", ProjectType),
    ("project_statuses", ProjectStatusDef),
    ("task_types", TaskType),
