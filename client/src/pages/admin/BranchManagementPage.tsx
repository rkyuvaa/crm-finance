...
const INITIAL_BRANCHES: Branch[] = [
  {
    ...
    code: 'BLR-HQ',
    type: 'Headquarters',
    address: 'Plot 102, Electronic City Phase 1, Hosur Main Road',
    city: 'Bangalore',
    state: 'Karnataka',
    pincode: '560100',
    ...
    working_days: 'Mon - Sat (6 Days)',
    manager_name: 'Rajesh Kumar',
    phone: '+91 80 2852 9900',
    email: 'blr.hq@kimfinance.com',
    status: 'ACTIVE',
  },
  {
    id: 2,
    ...
    code: 'MAA-HUB',
    type: 'Regional Hub',
    address: '45 Freight Corridor Complex, Sriperumbudur Industrial Zone',
    city: 'Chennai',
    state: 'Tamil Nadu',
    pincode: '602105',
    shift_name: '24/7 Operations (Rotation)',
    shift_start_time: '06:00 AM',
    shift_end_time: '02:30 PM',
    working_days: 'Mon - Sun (7 Days)',
    manager_name: 'Suresh Nair',
    phone: '+91 44 4390 1200',
    email: 'chennai.hub@kimfinance.com',
    status: 'ACTIVE',
  },
  {
    id: 3,
    name: 'Hyderabad Fleet Depot',
    code: 'HYD-DEP',
    type: 'Depot / Yard',
    address: 'Survey No 88, Outer Ring Road Logistics Park, Shamshabad',
    city: 'Hyderabad',
    state: 'Telangana',
    pincode: '501218',
    shift_name: 'Day & Evening Shift',
    shift_start_time: '08:00 AM',
    shift_end_time: '05:00 PM',
    working_days: 'Mon - Sat (6 Days)',
    manager_name: 'Priya Sharma',
    phone: '+91 40 6789 4411',
    email: 'hyd.depot@kimfinance.com',
    status: 'ACTIVE',
  },
  {
    id: 4,
    name: 'Mumbai West Regional Office',
    code: 'BOM-REG',
    type: 'Branch Office',
    address: 'Suite 401, Business Park, Andheri East',
    city: 'Mumbai',
    state: 'Maharashtra',
    pincode: '400069',
    shift_name: 'Corporate General Shift',
    ...
    email: 'mumbai.office@kimfinance.com',
    status: 'ACTIVE',
  },
];
